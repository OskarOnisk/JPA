...
insert into address (id, address_line1, address_line2, city, postal_code)
values (904, 'ef', 'uu', 'Wro', '30-200');

insert into address (id, address_line1, address_line2, city, postal_code)
values (905, 'ef', 'uu', 'Wro', '30-200');
...
insert into patient ( first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id)
values ( 'Piotr', 'Kowalczyk', '123456789', 'ja@kowal.pl', 'P002', '1980-01-01', 904);

insert into patient ( first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id)
values ( 'Jan', 'Nowak', '123456789', 'jan@kowal.pl', 'P003', '1980-01-01', 905);
...
insert into visit ( description, time, patient_id, doctor_id)
values ( 'Trzecia wizyta', '2026-03-16T10:00:00', 1, 1);

insert into visit ( description, time, patient_id, doctor_id)
values ( 'Czwarta wizyta', '2026-03-16T10:00:00', 2, 2);
